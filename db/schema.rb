...
ActiveRecord::Schema[7.2].define(version: 2025_04_10_095028) do
  ...
  create_table "carbon_calculations", force: :cascade do |t|
    ...
    t.index ["infrastructure_id"], name: "index_carbon_calculations_on_infrastructure_id"
  end
  ...
  add_foreign_key "carbon_calculations", "infrastructures"
end
